# Volume Control (Modified)
**Modifications**: Fixed process locking auto-selection bug (see [CHANGES.md](CHANGES.md))
> **Note**: This is a modified version of [Volume Control by radj307](https://github.com/radj307/volume-control).
> **Release Version**: 6.6.3
> **Original Project**: https://github.com/radj307/volume-control  
> **Modifications**: [Briefly describe what you changed - e.g., "Custom features added for personal workflow"]  
